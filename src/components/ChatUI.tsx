...
import { avatarFileName, type BotDeployment, type ChatLogMessage, validateChatInput } from '../lib/chatMessage';
...
export default function ChatUI({ botName }: ChatUIProps) {
       ...
       async function sendMessage() {
              ...
              const message: ChatLogMessage = {
                     ...
                     displayName: profile.displayName, backgroundColor: profile.backgroundColor, avatarDir: profile.avatar,
                     ...
                     <div ref={logRef} className="min-h-0 flex-1 overflow-y-auto py-4" aria-live="polite">
                            {messages.map(message => {
                                   ...
                                   const avatarPath = isBot
                                          ...
                                          : `/avatar/user/${message.avatarDir}/neutral.svg`;
                                   return (
